...
public class ExtUiScenarioReportProvider {
    public String insertListSql(List<ScenarioReportResultWrapper> list) {
        StringBuffer sqlList = new StringBuffer();
        sqlList.append("INSERT INTO ui_scenario_report (id, project_id, `name`, create_time, update_time, `status`, user_id, trigger_mode," +
        ...
        for (int i = 0; i < list.size(); i++) {
            ScenarioReportResultWrapper result = list.get(i);
            sqlList.append(" (")
                    .append("'")
                    .append(result.getId())
                    .append("','")
