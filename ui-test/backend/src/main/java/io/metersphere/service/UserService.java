...
import io.metersphere.utils.user.SessionUtils;
...
public class UserService {
    ...
    @Resource
    private BaseUserMapper extUserMapper;
    //    @Lazy
//    @Resource
//    private WorkspaceService workspaceService;
    ...
    @Resource
    private BaseUserGroupMapper extUserGroupMapper;
    @Resource
...
//        }
//        updateUser(user);
//        UserService userDTO = getUserDTO(user.getId());
...
//    }
    ...
    public UserDTO.PlatformInfo getCurrentPlatformInfo(String workspaceId) {
        ...
        JSONObject platformInfos = new JSONObject(platformInfoStr);
