...
public class KafkaConfig {
    ...
    public static final String DEBUG_TOPICS_KEY = "MS-UI-DEBUG-KEY";
    ...
    public NewTopic debugTopic() {
        return TopicBuilder.name(KafkaTopicConstants.UI_DEBUG_TOPICS)
                .build();
    }
    ...
    public static Map<String, Object> getKafka() {
        ...
        producerProps.put(DEBUG_TOPICS_KEY, KafkaTopicConstants.UI_DEBUG_TOPICS);
