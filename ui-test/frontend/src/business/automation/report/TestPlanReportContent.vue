...
import TestPlanFunctionalReport
  from "@/business/automation/report/components/TestPlanFunctionalReport";
import {
...
import TestPlanApiReport from "./detail/TestPlanApiReport";
import TestPlanUiReport from "./detail/TestPlanUiReport";
import TestPlanLoadReport from "./detail/TestPlanLoadReport";
import TestPlanReportContainer
  from "./detail/TestPlanReportContainer";
import TestPlanOverviewReport
  from "./detail/TestPlanOverviewReport";
import TestPlanSummaryReport from "./detail/TestPlanSummaryReport";
import TestPlanReportButtons from "./detail/TestPlanReportButtons";
import TestPlanReportNavigationBar
  from "./detail/TestPlanReportNavigationBar";
