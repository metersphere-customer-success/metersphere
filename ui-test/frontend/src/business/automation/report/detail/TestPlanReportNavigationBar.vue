...
import {DEFAULT_LANGUAGE, EN_US, ZH_CN} from "@/api/constants";
...
export default {
  ...
  mounted() {
    this.setData();
    if (this.needMoveBar) {
      this.toggleMoveBarClass(commandStore.appFixed);
    }
  },
  methods: {
    setData() {
...
.drawer-content :deep(.el-tabs__nav) {
