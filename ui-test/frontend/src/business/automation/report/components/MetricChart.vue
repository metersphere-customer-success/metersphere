    ...
    <el-row type="flex" align="middle">
      <div :style="{width: '65%'}">
        <el-row type="flex" justify="center" align="middle">
          ...
          <el-row type="flex" justify="center" align="middle" style="min-width: 170px">
            <div>
      ...
      <div class="split left-split"></div>
      <div class="common-split"></div>
      <!-- 场景统计 -->
      <div >
      ...
      <div class="common-split"></div>
      <div class="split right-split"></div>
