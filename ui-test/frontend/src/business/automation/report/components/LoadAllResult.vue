<template>
  <el-container>
    <ms-aside-container width="500px" :default-hidden-bottom-top="200" :enable-auto-height="true" pageKey="LOAD_ALL_RESULT">
...
import {checkoutLoadReport, shareCheckoutLoadReport} from "@/business/network/test-plan";
import LoadFailureResult from "@/business/automation/report/components/LoadFailureResult";
import LoadCaseReport from "@/business/automation/report/load/LoadCaseReport";
import LoadCaseReportView from "@/business/automation/report/load/LoadCaseReportView";
