...
import MsPieChart from "@/business/automation/scenario/component/case/plan/base/TemplateComponent/MsPieChart";
import MsDoughnutPieChart from "@/business/automation/scenario/component/MsDoughnutPieChart";
import ApiScenarioCharResult
  from "@/business/automation/report/detail/ApiScenarioCharResult";
export default {
  name: "UiResult",
