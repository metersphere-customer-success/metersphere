...
import FunctionalResult from "@/business/automation/report/components/FunctionalResult";
import FunctionalCases from "./FunctionalCases";
import FunctionalIssueList from "./FunctionalIssueList";
import TestPlanReportContainer
  from "@/business/automation/report/detail/TestPlanReportContainer";
