<template>
  <el-card class="ms-cards">
    <div class="request-result">
      ...
      <ui-screenshot-viewer ref="screenshotViewer"  v-if="lazyUnit && !isUnexecute && uiScreenshots && result.combinationImg"
...
<script>
import UiCommandResultDetail from "@/business/automation/report/UiCommandResultDetail";
...
export default {
  ...
  mounted() {
    if (this.result && this.result.uiScreenshots) {
