...
<script>
import {KeyValue, Scenario} from "@/api/ApiTestModel";
...
import MsApiVariableJson from "@/business/automation/scenario/edit/command/mock/ApiVariableJson";
import MsApiBodyFileUpload from "@/business/definition/body/ApiBodyFileUpload";
import Vue from 'vue';
import ApiVariableSetting from "@/business/automation/scenario/edit/command/mock/ApiVariableSetting";
