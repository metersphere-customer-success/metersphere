...
<script>
import ThreadGroup from "@/business/definition/jmeter/components/thread-group";
import TestPlan from "@/business/definition/jmeter/components/test-plan";
import {TYPE_TO_C} from "@/api/Setting";
import {baseSocket} from "@/api/base-network";
import {getBodyUploadFiles} from "@/api/api-automation";
...
export default {
  ...
  methods: {
    socketSync() {
      const uri = "/websocket/" + this.reportId;
      this.websocket = baseSocket(uri);
