  ...
  methods: {
    ...
    setParameter() {
      ...
      if (this.currentModule && this.currentModule.id != "root") {
        ...
        this.scenarioForm.moduleId = this.currentModule.id;
      } else {
        this.scenarioForm.modulePath = this.$t("commons.module_title");
        this.scenarioForm.moduleId = "default-module";
      }
      this.scenarioForm.level = "P0";
      this.scenarioForm.scenarioDefinition = {
        ...
        referenced: "Created",
        hashTree: [],
        projectId: this.scenarioForm.projectId
      }
    },
    ...
    open(currentModule) {
      this.scenarioForm = {principal: getCurrentUserId()};
