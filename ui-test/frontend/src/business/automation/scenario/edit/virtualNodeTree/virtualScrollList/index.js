...
const VirtualList = Vue.component("virtual-list", {
  ...
  watch: {
    ...
    elListener(newValue){
      if (newValue && this.pageMode) {
        this.updatePageModeFront();
        // this.el = document.querySelector(
        //   this.elListener
        // );
        this.el = this.elListener;
        if (this.el) {
  ...
  methods: {
    ...
    getClientSize() {
      ...
      if (this.pageMode) {
        return (
          this.el[key] || document.documentElement[key] || document.body[key]
        );
      } else {
        const { root } = this.$refs;
    ...
    scrollToOffset(offset) {
      if (this.pageMode) {
        if (this.el) {
          this.el[this.directionKey] = offset;
        } else {
