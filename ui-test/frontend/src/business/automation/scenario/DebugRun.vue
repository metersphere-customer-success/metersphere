  ...
  methods: {
    ...
    run() {
      ...
      let reqObj = {
        ...
        useCookie : this.runData.scenarioConfig ? this.runData.scenarioConfig.useCookie : false
      };
      ...
      reqObj = adaptToJackson(reqObj);
      this.runData.hashTree = adaptToJackson(this.runData.hashTree);
