...
import { getTypeNodeByProjectId} from "metersphere-frontend/src/api/file-metadata";
import {moveFileMeta} from "@/api/file";
...
export default {
  ...
  methods: {
    ...
    init() {
      this.dialogVisible = true;
      this.loading = true;
      this.result = getTypeNodeByProjectId(getCurrentProjectID(), 'module').then((response) => {
