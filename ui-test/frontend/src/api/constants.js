...
export const MOCKJS_FUNC = [
  ...
  {name: '@range', des: i18n.t('api_test.request.range'), ex: "[]"},
  ...
  {name: '@cparagraph', des: i18n.t('ui.cparagraph'), ex: "色青元处才不米拉律消叫别金如上。"},
  {name: '@csentence', des: i18n.t('ui.csentence'), ex: "与形府部速她运改织图集料进完。"},
  {name: '@cword', des: i18n.t('ui.cword'), ex: "满"},
  ...
  {name: '@ip', des: i18n.t('ui.ip'), ex: "22.151.93.255"},
