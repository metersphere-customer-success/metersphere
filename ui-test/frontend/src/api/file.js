...
import {getUploadConfig} from "@/api/ajax";
...
export function fileNameExists(param) {
  return post('/file/metadata/exist', param);
}
...
export function createFileMeta(file, data, success,err) {
...
export function uiFileUpload(bodyFiles, scenario, success, err) {
  let url='/ui/automation/save/file'
  let formData = new FormData();
