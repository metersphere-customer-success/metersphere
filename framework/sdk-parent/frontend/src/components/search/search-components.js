...
export const DATA_RULES_MODULE_TREE = _getModuleTree({
  url: "/rules/node/list",
  type: "POST",
  params: {} // 赋值时注意顺序
})
...
export const DATA_RULES_CONFIGS = [NAME, UPDATE_TIME, CREATE_TIME, DATA_RULES_MODULE_TREE, PRINCIPAL, TEST_PLAN_STATUS, STAGE, TAGS, FOLLOW_PEOPLE, ACTUAL_START_TIME, ACTUAL_END_TIME, PLAN_START_TIME, PLAN_END_TIME];
