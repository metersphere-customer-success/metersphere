...
*/
        ...
        for (EsbSheetDataStruct interfaceData : interfaceDataList) {
           ...
           /* apiDefinition.setModuleId(importRequest.getModuleId());
            ...
            apiDefinition.setRequest(genTCPSampler(esbSendRequest, reqDataStructStr,respDataStrutStr));
    ...
    private String genTCPSampler(String sendRequest, String esbDataStruct,String respDataStrutStr) {
...
//        frontScriptList.add(script);
        ...
        tcpSampler.setEsbDataStruct(JSONObject.parseArray(esbDataStruct, EsbDataStruct.class));
        tcpSampler.setBackEsbDataStruct(JSONObject.parseArray(respDataStrutStr, EsbDataStruct.class));
